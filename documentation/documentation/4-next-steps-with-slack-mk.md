...
8. then you'll need to create the file `/routes/slack-events.js` and add in the following code:
    ...
    3. now you'll need to commit your changes and push them to heroku if you went that route, but if you're using ngrok you SHOULD be able to try the url again on the Slack Event Subscriptions page and get it to work (it should say "Verified" in green).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMTQ3MTkyMCw5MDExOTIxOTBdfQ==
-->