...
2. In the code of the file, change the value of `title` from `Watch Together` to `Slack Tests Go Here`. Note: *do not change* `index` to `slack` and change 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA4NTI5NzY5OSwtMTM1Njg1MjA0MSwxNz
YwMjM3MTcxXX0=
-->